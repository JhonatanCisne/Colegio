...
import './EstilosBarraLateral.css'; // Asegúrate de que este archivo CSS exista
import logo from '../Imagenes/Escudo.png'; // Ruta de la imagen del logo

// --- Iconos para la barra lateral (SVGs) ---
    ...
    <>
      <aside className="sidebar">
        ...
        <div className="sidebar-footer">
          ...
          {/* CAMBIO AQUÍ: Redirige a /loginProfesor */}
          <Link to="/loginProfesor" className="logout-button"> 
            <LogoutIcon />
      ...
      {isMobileMenuOpen && (
        <nav className="mobile-nav">
          ...
          {/* CAMBIO AQUÍ: Redirige a /loginProfesor */}
          <Link to="/loginProfesor" className="nav-link logout" onClick={() => setIsMobileMenuOpen(false)}>Cerrar Sesión</Link>
        </nav>
      )}
    </>
  );
